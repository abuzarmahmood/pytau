...
HOW_TO_NOTEBOOKS_DIR = Path(__file__).parent.parent / "pytau" / "how_to" / "notebooks"
...
def test_notebook_structure(notebook_path):
    ...
    assert isinstance(notebook_content["cells"], list), f"Notebook {notebook_path} 'cells' is not a list"
