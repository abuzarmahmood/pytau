...
def test_plot_changepoint_raster(mock_spike_array, mock_tau):
    ...
    fig = plot_changepoint_raster(mock_spike_array[0], mock_tau, plot_lims=[10, 90])
    assert isinstance(fig, Figure)
...
def test_plot_aligned_state_firing(mock_spike_array, mock_tau, window_radius):
    ...
    fig = plot_aligned_state_firing(mock_spike_array, mock_tau, window_radius=window_radius)
